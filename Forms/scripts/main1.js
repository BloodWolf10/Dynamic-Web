...
function validateForm() {
    ...
    if (!email) {
      ...
      document.getElementById('email').textContent = 'Invalid email format needs an @ and .com';
      isValid = false;
    }
    ...
    if (!password) {
      ...
      document.getElementById('passwordError').textContent = 'Password must be at least 8 charaters long';
      isValid = false;
    }
